...
**Phosphodiester bods = nucleotides joining with each other**
The nucleotides join into polynucleotide chains via phosphodiester bonds. Phosphate groups connect the C3 of one nucleotide's deoxyribose to the C5 of the next.
...
**Glycosidic bonds = nucleotides/sides to ribose sugar**
Nucleotides are divided into puries (A,G) and pyrimidines (C,T), with purines bonding from their N9 and pyrimidines from their N1 to the sugar's C1. 
